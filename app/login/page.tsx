      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "1rem" }}>
            <ThemedOppyOrb mood="welcoming" size={40} />
          </div>
        ...
        {/* ── Google Sign-In (prominent, above the fold) ── */}
        <a
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <a
                ...
                style={{ fontSize: "0.75rem", color: "var(--accent-deep)" }}
              >
                Forgot password?
              </a>
            </div>
            <div style={{ position: "relative" }}>
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl text-sm"
                style={{ border: "1px solid var(--line)", background: "var(--paper)", color: "var(--ink)", paddingRight: 40 }}
              />
              <button
                type="button"
        ...
        <p style={{ textAlign: "center", marginTop: "1.25rem", fontSize: "0.85rem", color: "var(--ink-soft)" }}>
          No account? <a href="/signup" className="underline-hover" style={{ color: "var(--accent-deep)" }}>Sign up</a>
        </p>
      </div>
    </div>
  );
